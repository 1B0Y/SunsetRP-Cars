...
escrow_ignore {
  ...
  'carvariations.meta',
  'stream/*.ytd',
  'stream/polalamo_livery1.yft',
  'stream/polalamo_livery2.yft',
  'stream/polalamo_livery3.yft',
  'stream/polalamo_livery4.yft',
  'stream/polalamo_livery5.yft',
  'stream/polalamo_livery6.yft',
}
