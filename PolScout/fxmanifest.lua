...
escrow_ignore {
  ...
  'carvariations.meta',
  'stream/*.ytd',
  'stream/polscout_livery1.yft',
  'stream/polscout_livery2.yft',
  'stream/polscout_livery3.yft',
  'stream/polscout_livery4.yft',
  'stream/polscout_livery5.yft',
  'stream/polscout_livery6.yft',
}
